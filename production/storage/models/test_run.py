        ...
        for turn_data in doc["turns"]:
            ...
            if "latency" in turn_data and turn_data["latency"]:
                ...
                latency = LatencyMetrics(
                    ...
                    first_outbound_scn_ms=latency_data.get("first_outbound_scn_ms"),
                    last_outbound_scn_ms=latency_data.get("last_outbound_scn_ms"),
                    first_response_scn_ms=latency_data.get("first_response_scn_ms"),
                    first_audio_response_scn_ms=latency_data.get("first_audio_response_scn_ms"),
                    last_audio_response_scn_ms=latency_data.get("last_audio_response_scn_ms"),
                    first_text_response_scn_ms=latency_data.get("first_text_response_scn_ms"),
            ...
            turns.append(Turn(
                turn_id=turn_data["turn_id"],
                start_scn_ms=turn_data["start_scn_ms"],
                end_scn_ms=turn_data.get("end_scn_ms"),
